class MarksController < ApplicationController
  ...
  def index
    set_subjectName
    @marks = Mark.where('subject_id  = ?', "#{@teacher.subject.id}")
  end
  ...
  private
    ...
    def mark_params
      params.require(:mark).permit(:student_id, :subject_id, :individualMark)
    end
end
