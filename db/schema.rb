...
ActiveRecord::Schema.define(version: 2019_09_01_204520) do
  ...
  create_table "students", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "rollNo"
    t.index ["rollNo"], name: "index_students_on_rollNo", unique: true
  end
  ...
  create_table "subjects", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.index ["subjectCode"], name: "index_subjects_on_subjectCode", unique: true
